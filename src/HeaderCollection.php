...
/**
 * HeaderCollection is used by {@see \yii1tech\web\HttpRequest} to maintain the currently requested HTTP headers.
 *
 * @author Paul Klimov <klimov.paul@gmail.com>
 * @since 1.0
 */
class HeaderCollection extends \CComponent implements \IteratorAggregate, \ArrayAccess, \Countable
{
    /**
